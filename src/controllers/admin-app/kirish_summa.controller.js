    ...
    kirish = async(req, res, next) => {
        ...
        sum += (summa.dataValues.odam_price * body.odam_soni + summa.dataValues.moshina_price * body.mashina_soni);
         let model = await register_kirish.create({
            "date_time": date,
            "type": "Naqt",
            "price": body.odam_soni > 0 ? summa.dataValues.odam_price * body.odam_soni : 0,
            "mashina_soni": body.mashina_soni,
            "mashina_price": body.mashina_soni > 0 ? summa.dataValues.moshina_price * body.mashina_soni : 0,
