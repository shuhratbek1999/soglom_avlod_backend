...
router.get('/all', auth(), doctor.doctors, awaitHandlerFactory(doctorController.getAll));
router.get('/byName', auth(), awaitHandlerFactory(doctorController.byName));
router.get('/one/:id', doctor.doctorOne, awaitHandlerFactory(doctorController.getOne));
