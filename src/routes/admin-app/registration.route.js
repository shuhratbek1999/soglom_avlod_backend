...
router.get('/one/:id', auth(Role.Admin, Role.Dasturchi, Role.Kasser, Role.Loborant, Role.Shifokor), awaitHandlerFactory(registrationControl.getOne));
...
router.post('/create', auth(Role.Admin, Role.Dasturchi, Role.Loborant, Role.Shifokor), registrationValidate, awaitHandlerFactory(registrationControl.create));
...
router.patch('/update/:id', auth(Role.Admin, Role.Dasturchi, Role.Kasser, Role.Loborant, Role.Shifokor), registrationValidate, awaitHandlerFactory(registrationControl.update));
