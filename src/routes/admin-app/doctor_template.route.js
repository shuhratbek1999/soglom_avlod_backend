...
router.post('/create',auth(), awaitHandlerFactory(Doctor_templateController.create));
router.patch('/update/:id', auth(), awaitHandlerFactory(Doctor_templateController.update));
